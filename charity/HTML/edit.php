...
<!--------------------NavBar------------------>
        <nav class="navbar" >
           ...
           <a class="hvr-bounce-to-bottom nav-item "  href="../HTML/profile.php"style="color:#fff !important ;">My Profile</a>
          <a class="hvr-bounce-to-bottom active"  href="edit.php"style="color:#fff !important ;">Edit</a> 
          <a class="hvr-bounce-to-bottom  "  href="category.php"style="color:#fff !important ;">category</a>
          <a class="hvr-bounce-to-bottom "  href="Home.php"style="color:#fff !important ;">Home</a>
