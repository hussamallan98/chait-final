...
<!--------------------NavBar------------------>
        <nav class="navbar" >
           ...
           <a class="hvr-bounce-to-bottom nav-item "  href="profile.php" style="color:#fff !important ;">My Profile</a>
          <a class="hvr-bounce-to-bottom "  href="edit.php" style="color:#fff !important ;">Edit</a> 
          <a class="hvr-bounce-to-bottom  active"  href="category.php" style="color:#fff !important ;">category</a>
          <a class="hvr-bounce-to-bottom "  href="Home-1.php" style="color:#fff !important ;">Home</a>
          <a class="hvr-bounce-to-bottom"  href="#contact" style="color:#fff !important ;">Contact Us</a>
          <a class="hvr-bounce-to-bottom"  href="Home-1.php#portal" style="color:#fff !important ;">Log Out <i class="fas fa-door-open"></i></a>
      </nav>
<!--------------------NavBar------------------>
  ...
  <div class="post mb-5">
    ...
    <div class="row " style="">
        ...
        foreach ($arr as $key => $v) {
            ...
            echo "<img class='card-img-top mt-3' width='100%' height='250px' src='admin/img/{$v['cat_image']}' alt='Card image cap'>";
    ...
    <div class="card col-md-3" style="width: 18rem;">
        <img class="card-img-top mt-3" width="100%" src="admin/img/learning.jpg" alt="Card image cap" style="margin: 0px; padding: 0px;">
        <div class="card-body">
